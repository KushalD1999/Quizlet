...
public class Screen9 extends JFrame {
	...
	/**
	 * Constructor for screen 9 that has the game mechanics and the layout and dimensions.
	 */
	...
	public Screen9() {
		...
		//questions splitted out through
		...
		//does the same thing as other clasees remaining changes that changes the options location and if user answers it correctly then continues the game or ask user if he wants to play the game again and if user agrees resets the game.
		if(change==1)
		{
			...
			option1.addActionListener(new ActionListener(){
				public void actionPerformed(ActionEvent arg){
					...
					if(Target.sc==8 && Target.c != 1)
					{
						Target.c = 1;
						Screen1.score = 1000000;
					}
					else
					{
						Screen1.score = 0;
		...
		//Score bar with the label score
				...
				panel.setBounds(979, 288, 113, 36);
