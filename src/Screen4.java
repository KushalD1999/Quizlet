...
public class Screen4 extends JFrame {
	...
	/**
	 * Constructor for screen 4 that has the game mechanics and the layout and dimensions.
	 */
	...
	public Screen4() {
		...
		//displays the question extracted from file.
		...
		//the first button is set as the ans.
		if(change==1)
		{
			option1 = new JButton(ans);
			option1.addActionListener(new ActionListener(){
				public void actionPerformed(ActionEvent arg){
					//if the target is met the score is updated.
					if(Target.sc==3 && Target.c != 1)
					{
						Target.c = 1;
						Screen1.score = 10000;
					}
					//score is set to 0 if target is not met.
					else
					{
						Screen1.score = 0;
					}
					...
					//timer is stopped as the ans is right
					time.stop();
					//open the next screen
				  	Screen5 s=new Screen5();
					s.setVisible(true);
					close();
				}
			});
			...
			//if user anwers wrong answer or selects wrong option from other 3
			...
			//if user ans is wrong.
			 ...
			 option4.addActionListener(new ActionListener(){
					public void actionPerformed(ActionEvent arg){
						//The score is set appropriately
						if(Target.c != 1)
	        			{
							Screen1.score = 0;
	        			}
		...
		//The second button is set as the ans.
		if(change==2)
		{
			//if the ans is wrong.
			...
			//the right ans is picked
			option2 = new JButton(ans);
			option2.addActionListener(new ActionListener(){
				public void actionPerformed(ActionEvent arg){
					//score is updated appropriately 
					if(Target.sc==3 && Target.c != 1)
					{
						Target.c = 1;
						Screen1.score = 10000;
			 ...
			 option3.addActionListener(new ActionListener(){
					public void actionPerformed(ActionEvent arg){
						...
						int res = JOptionPane.showOptionDialog(null, "Would you like to play again?", "Wrong answer", JOptionPane.ERROR_MESSAGE,
		        		        JOptionPane.INFORMATION_MESSAGE, null, null, null);
		        		if(res==0){
		        			//variables are reseted if user plays again.
		    				Leaderboard.addScore(Screen1.score);
		        			Screen1 s=new Screen1();
		        			s.setVisible(true);
		    				Screen1.score = 0;
			...
			//wrong ans is picked 
			 ...
			 option4.addActionListener(new ActionListener(){
					public void actionPerformed(ActionEvent arg){
						...
						//user is prompted to play again of quit
	    				JOptionPane.showMessageDialog(null, "Sorry your answer was wrong. You have won " + Screen1.score);
						int res = JOptionPane.showOptionDialog(null, "Would you like to play again?", "Wrong answer", JOptionPane.ERROR_MESSAGE,
		        		        JOptionPane.INFORMATION_MESSAGE, null, null, null);
		        		if(res==0){
		        			//variables are reseted is player quits.
		    				Leaderboard.addScore(Screen1.score);
		        			Screen1 s=new Screen1();
		        			s.setVisible(true);
		    				Screen1.score = 0;
		...
		//The third button is set as the ans.
		if(change==3)
		{
			//if the ans picked is wrong.
			 option1 = new JButton(op2);
			 option1.addActionListener(new ActionListener(){
					public void actionPerformed(ActionEvent arg){
						//scores are set appropriately 
						...
						int res = JOptionPane.showOptionDialog(null, "Would you like to play again?", "Wrong answer", JOptionPane.ERROR_MESSAGE,
		        		        JOptionPane.INFORMATION_MESSAGE, null, null, null);
		        		if(res==0){
		        			//variables are reseted if the player quits
		    				Leaderboard.addScore(Screen1.score);
		        			Screen1 s=new Screen1();
		        			s.setVisible(true);
		    				Screen1.score = 0;
			 ...
			 option2.addActionListener(new ActionListener(){
					public void actionPerformed(ActionEvent arg){
						...
						int res = JOptionPane.showOptionDialog(null, "Would you like to play again?", "Wrong answer", JOptionPane.ERROR_MESSAGE,
		        		        JOptionPane.INFORMATION_MESSAGE, null, null, null);
		        		if(res==0){
		        			//variables are reseted if user quits
		    				Leaderboard.addScore(Screen1.score);
		        			Screen1 s=new Screen1();
		        			s.setVisible(true);
		    				Screen1.score = 0;
			 ...
			 option4.addActionListener(new ActionListener(){
					public void actionPerformed(ActionEvent arg){
						...
						int res = JOptionPane.showOptionDialog(null, "Would you like to play again?", "Wrong answer", JOptionPane.ERROR_MESSAGE,
		        		        JOptionPane.INFORMATION_MESSAGE, null, null, null);
		        		if(res==0){
		        			//variables are reseted if player quits.
		    				Leaderboard.addScore(Screen1.score);
		        			Screen1 s=new Screen1();
		        			s.setVisible(true);
		    				Screen1.score = 0;
		...
		//The text properties of the screen.
		...
		//highlighting the score for the question.
		JPanel panel = new JPanel();
		panel.setBackground(Color.BLACK);
		panel.setBounds(965, 493, 113, 36);
		...
		//if the player chooses to quit and walk away.
		...
		//If the player wants to play a new game and retry
