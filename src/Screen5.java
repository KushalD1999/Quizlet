...
public class Screen5 extends JFrame {
	...
	/**
	 * Constructor for screen 5 that has the game mechanics and the layout and dimensions.
	 */
	public Screen5() {
		...
		//first button is set as the ans
		if(change==1)
		{
		...
		panel.setBounds(965, 458, 113, 36);
