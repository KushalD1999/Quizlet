...
public class Screen8 extends JFrame {
	...
	/**
	 * Constructor for screen 8 that has the game mechanics and the layout and dimensions.
	 */
	public Screen8() {
		...
		//Score bar with the label score
				...
				panel.setBounds(971, 335, 113, 36);
